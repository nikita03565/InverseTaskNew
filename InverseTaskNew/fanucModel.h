...
#include "../InverseTaskNew/RoboModel.h"
...
*/
class FanucModel : public RoboModel
{
    /**
...
public:
    ...
    * \return Matrix of solutions.
    */
    cv::Mat inverseTask(const std::array<double, 6>& coord);
    ...
    */
    ...
    std::vector<RoboModel::DhParameters> getDhParameters() const;
