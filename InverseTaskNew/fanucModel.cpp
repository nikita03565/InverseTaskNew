...
cv::Mat FanucModel::inverseTask(const std::array<double, 6>& coordIn)
{
    ...
    //std::cout << "thetaRes:\n" << thetaRes * 180.0 / PI << '\n';
    int k = 4;
    cv::Mat thetaPrefinal(thetaRes.rows * k, 6, cv::DataType<double>::type);
    ...
    for (int it = 0; it < thetaRes.rows; ++it)
    {
        ...
        {
            thetaPrefinal.at<double>(it * k + zt, 0) = thetaRes.at<double>(it, 0);
            thetaPrefinal.at<double>(it * k + zt, 1) = thetaRes.at<double>(it, 1);
            thetaPrefinal.at<double>(it * k + zt, 2) = thetaRes.at<double>(it, 2);
        }
        ...
        thetaPrefinal.at<double>(it * k + 1, 3) = PI + thetaPrefinal.at<double>(it * k, 3);
        thetaPrefinal.at<double>(it * k + 1, 4) = -thetaPrefinal.at<double>(it * k, 4);
        thetaPrefinal.at<double>(it * k + 1, 5) = PI + thetaPrefinal.at<double>(it * k, 5);
                                      
        thetaPrefinal.at<double>(it * k + 2, 3) = -PI + thetaPrefinal.at<double>(it * k, 3);
        thetaPrefinal.at<double>(it * k + 2, 4) = -thetaPrefinal.at<double>(it * k, 4);
        thetaPrefinal.at<double>(it * k + 2, 5) = -PI + thetaPrefinal.at<double>(it * k, 5);
                                      
        thetaPrefinal.at<double>(it * k + 3, 3) = PI + thetaPrefinal.at<double>(it * k, 3);
        thetaPrefinal.at<double>(it * k + 3, 4) = -thetaPrefinal.at<double>(it * k, 4);
        thetaPrefinal.at<double>(it * k + 3, 5) = -PI + thetaPrefinal.at<double>(it * k, 5);
    }
